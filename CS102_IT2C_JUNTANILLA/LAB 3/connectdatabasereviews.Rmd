...
Checking contents of the columns
```{r}
data_show <- dbGetQuery(connection, "SELECT * FROM database_rev.reviews")
glimpse(data_show)
...
review <- read.csv("Reviewsdatabase.csv")
